...
local function Round(Value, Rounding, Min, Max)
    ...
    if Rounding == 0 then
        ...
        Result = tonumber(string.format("%." .. Rounding .. "f", Value))
    end
...
do
    ...
    function Funcs:AddSlider(Idx, Info)
        ...
        local Slider = {
            Text = Info.Text,
            Value = Round(Info.Default, Info.Rounding, Info.Min, Info.Max),
        ...
        function Slider:SetValue(Str)
            ...
            Num = Round(math.clamp(Num, Slider.Min, Slider.Max), Slider.Rounding, Slider.Min, Slider.Max)
        ...
        Bar.InputBegan:Connect(function(Input: InputObject)
            ...
            while IsDragInput(Input) do
                ...
                Slider.Value = Round(
                    Slider.Min + ((Slider.Max - Slider.Min) * Scale),
                    Slider.Rounding,
                    Slider.Min,
                    Slider.Max
                )
